          ...
          <div class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full pl-10">
            <TransitionChild as="template" enter="transform transition ease-in-out duration-500 sm:duration-700"
              ...
              <DialogPanel class="pointer-events-auto w-screen max-w-md">
                <div class="flex h-full flex-col overflow-y-scroll bg-customBlue py-6 shadow-xl">
                  <div class="px-4 sm:px-6">
                    <div class="flex items-start justify-between">
                      ...
                      <div class="ml-3 flex h-7 items-center">
                        <button type="button"
                          class="relative rounded-md bg-customBlue text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                          @click="closePanel">
                  ...
                  <div class="relative mt-6 flex-1 px-4 sm:px-6">
                    <nav class="flex flex-col">
                      <NuxtLink v-for="menu in menus" :key="menu.name" :to="menu.link"
                        class="transition p-5 duration-500 ease-in-out text-white hover:bg-customBlue hover:text-black rounded h-full">
